...
export const TransactionHistory: React.FC<TransactionHistoryProps> = ({
  ...
  const formatAmountUSD = (amountUSD: number, type: TransactionType['type']) => {
    const sign = type === 'receive' || type === 'buy' ? '+' : '-';
        ...
        {displayTransactions.map((transaction) => (
          ...
          >
            <div className="transaction-history__item-left">
              <div className={`transaction-history__icon transaction-history__icon--${transaction.type}`}>
            ...
            <div className="transaction-history__item-right">
              ...
              >
                {formatAmount(transaction.amount, transaction.type)} {transaction.asset}
              </div>
