  ...
  return (
    <div className="pb-5">
      <div className="flex justify-between items-center mb-4">
        <h2 className="m-0 text-lg font-semibold" style={{ color: 'var(--color-text)' }}>
          Your Assets
        </h2>
        <button 
      ...
      <div className="grid grid-cols-2 gap-3">
            ...
            >
              <div className="inline-flex items-center gap-3">
                ...
                <div className="inline-flex flex-col items-start">
                  <div className="text-gray-100 text-base font-semibold leading-snug">{asset.name}</div>
                  <div className="text-neutral-400 text-base font-semibold leading-snug">{formatBalance(asset.balance, asset.symbol)}</div>
                </div>
              </div>

              <div className="flex flex-col items-start gap-2">
                <div className="justify-center">
                  <span className="text-gray-100 text-2xl font-bold leading-relaxed tracking-wide">{currencySymbol}{baseInt}</span>
                  <span className="text-neutral-400 text-2xl font-medium leading-relaxed tracking-wide">.{baseDec}</span>
                </div>
                <div className="inline-flex items-start gap-2">
                  <div className="text-neutral-400 text-sm font-medium leading-tight">{currencySymbol}{formatPrice(asset.price)}</div>
                  <div className={`text-sm font-medium leading-tight ${asset.priceChange24h >= 0 ? 'text-green-500' : 'text-rose-500'}`}>
        ...
        {filteredAssets.length === 0 && (
          <div className="col-span-2 text-center py-10" style={{ color: 'var(--color-hint)' }}>
