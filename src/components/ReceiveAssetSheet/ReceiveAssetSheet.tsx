    ...
    <div className="fixed inset-0 z-[60] bg-zinc-950/95 overflow-y-auto">
      ...
      <div className="w-full px-4 pt-4 flex justify-between items-center sticky top-0">
        ...
        <div className="text-gray-100 text-base font-bold">
          Receive {getSymbolWithNetwork(asset.symbol)}
        </div>
      ...
      <div className="px-4 mt-6 pb-6">
        <div
          ...
          {copied && (
            <div
              className="self-stretch text-center text-emerald-400 text-sm font-medium leading-tight"
              aria-live="assertive">
              Copied to clipboard
            </div>
          )}
      ...
      <div className="px-4 mt-4 pb-10">
        <button
          className="w-full h-14 p-3 bg-blue-500 rounded-2xl inline-flex justify-center items-center gap-2.5"
          onClick={handleShare}
          disabled={!address}>
