        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="text-center">
            <p className="text-neutral-400 text-sm font-['Manrope']">
              Import an existing wallet using your 12 or 24-word recovery
              phrase.
            </p>
          </div>
          ...
          <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-3">
            <p className="text-amber-200 text-sm font-['Manrope'] leading-relaxed">
              <strong>Security Note:</strong> Make sure you're in a private
              location. Never share your recovery phrase with anyone.
            </p>
          </div>
