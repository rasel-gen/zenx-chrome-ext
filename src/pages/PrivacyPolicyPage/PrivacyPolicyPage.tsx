      ...
      <div className="min-h-screen relative bg-zinc-950 overflow-hidden">
        ...
        <div className="px-4 py-4">
          <div className="flex flex-col gap-3 text-neutral-300 text-sm leading-relaxed">
            <p>
              We respect your privacy. ZenX Wallet does not sell your data. We
              only use your Telegram account identifier to create and manage
              wallets for supported networks, and to provide basic app features.
            </p>
            <p>
              We do not store private keys in this app. Addresses and balances
              may be queried from public blockchain APIs solely to display your
              wallet information.
            </p>
            <p>
